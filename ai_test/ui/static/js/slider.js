class Slider {
    ...
    updateNavButtons() {
        ...
        // Ensure hover effect works on selected thumbnail
        this.navButtons.forEach((button) => {
            if (button.getAttribute("aria-selected") === "true") {
                button.classList.add("hover"); // Manually trigger hover effect on selected
            } else {
    ...
    eventListeners() {
        ...
        this.sliderNavigation.addEventListener("wheel", (e) => {
            this.sliderNavigation.scrollLeft += e.deltaY;
        });
    }
